...
class Hospital(models.Model):
    ...
    image = models.ImageField(
        upload_to="media/", null=True, default="media/no_hospital_img.png")
...
class User(AbstractBaseUser):
    # unique checks existance with respect to save function
...
class Owner(models.Model):
    my_account = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="my_owner")
...
class Patient(models.Model):
    my_account = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="my_patient")
...
class Doctor(models.Model):
    my_account = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="my_doctor")
...
class Schedule(models.Model):
    ...
    doctor = models.ForeignKey(
        Doctor, on_delete=models.CASCADE, related_name="dailyschedule")
...
class Review(models.Model):
    doctor = models.ForeignKey(
        Doctor, on_delete=models.CASCADE, related_name="my_reviews")
    patient = models.ForeignKey(
        Patient, on_delete=models.CASCADE, related_name="my_comments")
